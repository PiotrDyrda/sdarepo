...
public class PeselValidator {
    ...
    public static int[] weights = new int[]{9, 7, 3, 1, 9, 7, 3, 1, 9, 7};
    public static int[] daysInMonth = new int[]{31, 0, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31};
    public static int[] centuries = new int[]{1900, 2000, 2100, 2200, 1800};
    ...
    public static List<ValidationErrors> validate(String pesel) {
        ...
        if(!hasCorrectLength(pesel)){
            errors.add(ValidationErrors.INVALID_LENGHT);
            return errors;
        }
        ...
        if(!hasCorrectChecksum(pesel)){
            errors.add(ValidationErrors.INVALID_CHECK_SUM);
        }
